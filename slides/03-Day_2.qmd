...
```{r}
#| eval: false
#| code-line-numbers: "|1-6|2,4|8-25"
...
```{r}
#| eval: false
#| code-line-numbers: "|15-16,20|53-56"
#| file: "../demos/demo13.R"
```
...
In the case of our Shiny app, all we need to do is to include a call to `thematic_shiny()` before the app is loaded. Using the value `"auto"` will attempt to resolve the `bg`, `fg`, `accent`, or `font` values at plot time.
